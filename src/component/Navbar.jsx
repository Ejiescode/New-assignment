...
<svg
      ...
      <ul className="lg:flex hidden gap-7 items-center flex-column font-semibold cursor-pointer">
       {<Link to="/Products">
        ...
        <div className="flex lg:hidden text-2xl z-10">
             {isMobileNav ? (
              ...
              // className="mt-[55px] lg:mt-[35px] lg:ml-0 ml-[10px]"
              />
              )}
            </div>
      ...
      <div  className="lg:flex hidden gap-5 items-center font-bold px-10 mb-[500px]">
      {<Link to="/login">
       <button className="px-3 py-2 border-2 rounded-xl border-grey">
        Login
        </button>
       </Link>}
       
       { <Link to="/reg">
        <button className="px-3 py-2 bg-[#00a2ff] hover:bg-white 
        hover:border-[#00a2ff] hover:text-[#00a2ff] hover:border-2
        text-white rounded-xl  ">
            Sign in for free
        </button></Link>}
      </div>
</nav>
       {isMobileNav && <nav className=" lg:w-[50%] absolute lg:left-[1000px] left-[30px] bg-white 
        w-[100%] h-screen p-6 items-center lg:top-[100px] top-0 flex lg:hidden">
